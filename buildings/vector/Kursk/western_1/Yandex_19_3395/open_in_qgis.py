...
raster_paths = [
    '../data/raster/Kursk/Yandex_19_3395.tif'
]

vector_paths = [
    '../data/buildings/vector/Kursk/western_1/Yandex_19_3395/roofs.shp',
    '../data/buildings/vector/Kursk/western_1/Yandex_19_3395/projes.shp',
    '../data/buildings/vector/Kursk/western_1/Yandex_19_3395/shades.shp'
]
